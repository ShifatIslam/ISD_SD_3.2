...
namespace CarRental
{
    ...
    public partial class UserSignUp : System.Web.UI.Page
    {
        ...
        bool Checkuser()     //user are u  there??
        {
            try
            {
        ...
        bool Checknid() //hmph..let me verify you
        {
            try
            {
                ...
                if (rd1.HasRows)
                {
                    ...
                    if (fullname != fname || address != ar || location != loc || city != ci || dob != dateofbirth || gender != gen || occupation != occ || contact != cont || nationality != nation || license != driving) //so long checking
                    {
                        return true;
                    }
                    else
